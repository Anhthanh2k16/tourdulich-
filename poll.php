...
if(mysql_num_rows($query) > 0)
{
 ...
 echo "<h2>Hiện tại bạn đang sử dụng ắc quy nào ?</h2>";
 $sql2="select * from table_tinnho where com=1 and qid='$qid' order by id limit 0,8";
 ...
 echo "<input value='' style='background:url(images/binhchon.png) no-repeat;background-size: cover;width: 125px;height: 33px;border: coral;' type='submit' name='ok' >";
 echo "</form>";
}
?>
